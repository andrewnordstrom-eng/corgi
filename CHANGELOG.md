...
### Changed
- Align local, CI, and container runtimes on Node 22.23.2 with blocking engine checks, a digest-pinned Bookworm slim image for native dependencies, and required source revision stamping (PROJ-2228).
